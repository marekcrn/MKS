...
int main(void)
{
  ...
  static uint32_t LEDposition=0;
  static uint32_t direction=1;

  while (1)
  {		// Direction of knight rider
		if (LEDposition == 0)
		{
			direction = 1;
		}
		else if (LEDposition==9)
		{
			direction = 0;
		}

		// Current position for LEDs
		if (direction == 1)
		{
			LEDposition++;
		}
